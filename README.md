...
## Key Features
1. Friend Management: Track days since last contact with status indicators (On-track, Overdue, etc.). <br>
2. Interactive Timeline: Log and filter interactions like Calls, Texts, and Video calls.<br>
3. Friendship Analytics: Visual representation of interaction history using Pie Charts. <br>
